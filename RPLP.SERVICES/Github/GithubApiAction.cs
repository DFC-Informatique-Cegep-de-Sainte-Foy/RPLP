...
namespace RPLP.SERVICES.Github
{
    public class GithubApiAction
    {
        ...
        private static async Task<List<Repository_JSONDTO>> OrganisationRepositoryGithubApiRequest(string p_githubLink)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, "Requête GET pour les dépots d'une organisation"));
        ...
        private static async Task<Repository_JSONDTO> RepositoryInfoGithubApiRequest(string p_githubLink)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, "Requête GET pour les infos d'un dépot"));
        ...
        public List<Branch_JSONDTO> GetRepositoryBranchesGithub(string p_organisationName, string p_repositoryName)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log($"fullPath: {fullPath}"));
        ...
        private static async Task<List<Branch_JSONDTO>> RepositoryBranchesGithubApiRequest(string p_githubLink)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, "Requête GET pour les branches d'un dépots"));
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log($"GithubApiAction - RepositoryBranchesGithubApiRequest(string p_githubLink: {p_githubLink}) - refs: {refs.Count}"));
            return refs;
        }
        ...
        private static async Task<List<Commit_JSONDTO>> RepositoryCommitsGithubApiRequest(string p_githubLink)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, "Requête GET pour les commits d'un dépots"));
        ...
        private static async Task<List<PullRequest_JSONDTO>> RepositoryPullRequestsGithubApiRequest(string p_githubLink)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, "Requête GET pour les pull requests d'un dépots"));
        ...
        public string CreateNewBranchForFeedbackGitHub(string p_organisationName, string p_repositoryName, string p_sha, string p_newBranchName)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log($"GithubApiAction - CreateNewBranchForFeedbackGitHub - statusCode: {statusCode.Result} - organisationName:{p_organisationName} - p_repositoryName:{p_repositoryName} - p_newBranchName: {p_newBranchName}"));
            statusCode.Wait();
            RPLP.JOURNALISATION.Logging.Journal(new Log($"GithubApiAction - CreateNewBranchForFeedbackGitHub - statusCode.Wait() - statusCode: {statusCode.Result}"));
        ...
        private async Task<string> NewBranchForFeedbackGithubApiRequest(string p_githubLink, string p_sha, string p_newBranchName)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log($"GithubApiAction - NewBranchForFeedbackGithubApiRequest - branchRequest: {branchRequest} - p_githubLink: {p_githubLink} - p_newBranchName: {p_newBranchName}"));
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, $"Requête POST pour la création de la branche \"{p_newBranchName}\" pour Feedback"));
        ...
        private async Task<string> NewPullRequestFeedbackGitHubApiRequest(string p_githubLink, string p_targetBranch, string p_title, string p_body, string p_fromBranch)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, $"Requête POST pour la création d'une pull request pour Feedback vers la branche \"{p_targetBranch}\""));
        ...
        public string AddStudentAsCollaboratorToPeerRepositoryGithub(string p_organisationName, string p_repositoryName, string p_studentUsername)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log($"GithubApiAction - CreateNewPullRequestFeedbackGitHub - statusCode: {statusCode.Result} - organisationName:{p_organisationName} - p_repositoryName:{p_repositoryName} - p_studentUsername: {p_studentUsername}"));
            statusCode.Wait();
            RPLP.JOURNALISATION.Logging.Journal(new Log($"GithubApiAction - CreateNewPullRequestFeedbackGitHub - statusCode: {statusCode.Result} - organisationName:{p_organisationName} - p_repositoryName:{p_repositoryName} - p_studentUsername: {p_studentUsername}"));
        ...
        private async Task<List<Collaborator_JSONDTO>> GetCollaboratorFromStudentRepositoryGithubGithubApiRequest(string p_githubLink)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, "Requête GET pour les collaborateurs d'un dépot étudiant"));
        ...
        private async Task<string> AddStudentAsCollaboratorToPeerRepositoryGithubApiRequest(string p_githubLink)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log($"GithubApiAction - AddStudentAsCollaboratorToPeerRepositoryGithubApiRequest - permission: {permission} - response: {response.StatusCode.ToString()}"));
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, "Requête PUT pour l'ajout d'un étudiant en tant que collaborateur à un dépot"));
        ...
        private async Task<string> RemoveStudentAsCollaboratorFromPeerRepositoryGithubApiRequest(string p_githubLink)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, "Requête DELETE pour la suppression d'un étudiant comme collaborateur d'un dépot"));
        ...
        private async Task<string> AssignReviewerToPullRequestGitHubApiRequest(string p_githubLink, string p_studentUsername)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, $"Requête POST pour l'assignation d'un reviewer (\"{p_studentUsername}\") à une pull request"));
        ...
        private async Task<string> addFileToContentsGithubApiRequest(string p_githubLink, string p_branchName, string p_content, string p_message)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log($"GitHubApiAction - addFileToContentsGithubApiRequest" +
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(p_githubLink, (int)response.StatusCode, remaining, $"Requête PUT pour ajouter un fichier à un dépot - status : {response.StatusCode.ToString()}"));
        ...
        public HttpResponseMessage DownloadRepository(string p_organisationName, string p_repositoryName)
        {
            ...
            RPLP.JOURNALISATION.Logging.Journal(new Log(fullPath, (int)task.Result.StatusCode, remaining, "Requête GET pour télécharger un dépot"));
