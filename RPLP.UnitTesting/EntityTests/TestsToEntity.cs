...
namespace RPLP.UnitTesting.EntityTests
{
    public class TestsToEntity
    {
        ...
        public void Test_Assignment_ToEntity()
        {
            ...
            Assert.Equal(assignmentSQLDTO.ClassroomId, assignment.ClassroomId);
        ...
        public void Test_Classroom_ToEntity()
        {
            ...
            Assert.Equal(classroomSQLDTO.OrganisationId, classroom.OrganisationId);
        ...
        public void Test_Repository_ToEntity()
        {
            ...
            Assert.Equal(repository_SQLDTO.OrganisationId, repository.OrganisationId);
        }
        ...
        public void Test_Student_ToEntity()
        {
            ...
            Assert.Equal(student_SQLDTO.Matricule, student.Matricule);
